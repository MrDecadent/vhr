...
public class MailConstants {
    ...
    public static final String MAIL_QUEUE_NAME = "dcd.mail.queue";
    public static final String MAIL_EXCHANGE_NAME = "dcd.mail.exchange";
    public static final String MAIL_ROUTING_KEY_NAME = "dcd.mail.routing.key";
}
